...
func initMenu() xcgui.HMENUX {
	hMenu := xcgui.XMenu_Create()
	xcgui.XMenu_SetAutoDestroy(hMenu, false)
	//xcgui.XMenu_EnableDrawBackground(hMenu, true)
	//xcgui.XMenu_EnableDrawItem(hMenu, true)
...
func OnbtnClick(hEventEle xcgui.HELE, pbHandled *bool) int {
	...
	xcgui.XMenu_Popup(hMENUX, xcgui.XWnd_GetHWND(hWindow), pt.X, pt.Y, 0, 0)

	//XMenu_Popup (HMENUX hMenu, HWND hParentWnd, int x, int y, HELE hParentEle, menu_popup_position_ nPosition)
